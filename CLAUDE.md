...
- **A comment that does get written should read like plain English, not shorthand** — explain _why_ in ordinary words a newcomer could follow in one pass, even if that takes a couple of plain sentences rather than one dense jargon-packed line. Applies to the rare non-obvious-why case above and to any comment added because it was explicitly requested.
