 ...
 *
 * Lists a company's contractor projects.
 *
 * ## Authentication
 *
 * This endpoint requires the following token type:
 ...
 * | Category | Read only Scope | Write only Scope (read access implicit) |
 * |---|---|---|
 * | Manage company resources (`company_admin`) | - | Manage benefit offers (`benefit_offer:write`) |
 */
...
/**
 * Show a single company project
 *
 * Shows a single contractor project by its ID.
 *
 * ## Authentication
 *
 * This endpoint requires the following token type:
 ...
 * | Manage employments (`employments`) | - | Manage employments (`employment:write`) |
 */
export const postV2EmploymentsEmploymentIdJobTitleEligibilityCheck = <
  ThrowOnError extends boolean = false,
>(
  options: Options<
    PostV2EmploymentsEmploymentIdJobTitleEligibilityCheckData,
