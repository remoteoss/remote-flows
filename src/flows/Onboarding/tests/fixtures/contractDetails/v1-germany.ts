export const contractDetailsSchemaV1Germany = {
  data: {
    ...
    properties: {
      ...
      contract_duration_type: {
        ...
        default: 'fixed_term',
        description:
          "An employee hired under the AUG model in Germany is limited to a maximum employment duration of 18 months. If you're considering extending your collaboration before the end of this period, please contact your Account Executive to explore other available hiring options.",
        oneOf: [
          {
            const: 'fixed_term',
            title: 'Fixed Term',
