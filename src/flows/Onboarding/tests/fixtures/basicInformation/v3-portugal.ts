export const basicInformationSchemaV3Portugal = {
  data: {
    ...
    properties: {
      ...
      has_seniority_date: {
        description:
          'If the employee worked for your company before joining Remote, select whether you want to recognize their previous seniority.<br/>Selecting <b>Yes</b> will adversely impact other employment actions including background checks.',
        oneOf: [
          {
            const: 'yes',
            title: 'Yes',
        ...
        'x-jsf-presentation': {
          ...
          meta: {
            helpCenter: {
              callToAction: 'Learn more about seniority dates',
    ...
    'x-jsf-fieldsets': {
      seniority_date: {
        propertiesByName: ['has_seniority_date', 'seniority_date'],
        title: 'Seniority date',
      },
    },
    'x-jsf-logic': {
