  ...
  data: {
    ...
    properties: {
      ...
      has_seniority_date: {
        ...
        title:
          '<strong>Previous seniority cannot be recognized in South Korea</strong>',
        type: 'string',
        'x-jsf-presentation': {
          direction: 'row',
          inputType: 'radio',
      ...
      provisional_start_date: {
        description:
          'The minimum onboarding time for South korea is 20 working days. We will confirm the start date once you invite the employee to do the self-enrollment.',
        format: 'date',
        maxLength: 255,
