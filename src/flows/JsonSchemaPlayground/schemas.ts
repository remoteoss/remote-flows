  ...
  'france-wage-portage': {
    ...
    schema: {
      ...
      properties: {
        ...
        mission_duration: {
          description:
            'The minimum expected duration of the mission. Missions can have a maximum duration of 36 months for employees.',
          maximum: 36,
          minimum: 1,
        ...
        non_compete_compensation_salary_percentage: {
          default: 30,
          description:
            'In France, non-compete pay must be 30% of monthly base salary throughout the post termination restrictions.',
          readOnly: true,
        ...
        non_compete_restricted_activities: {
          description:
            'Please define the specific professional activities the employee is prohibited from engaging in after leaving the company.',
          maxLength: 5000,
          minLength: 20,
        ...
        business_allowances_statement: {
          ...
          'x-jsf-logic-computedAttrs': {
            'x-jsf-presentation': {
              statement: {
                description:
                  '<strong>Mandatory allowances</strong><br /><br />Under French Wage Portage regulations, the following amounts are required by law.',
              },
            },
          },
          'x-jsf-presentation': {
      ...
      required: ['contract_duration_type', 'annual_gross_salary'],
      type: 'object',
      'x-jsf-logic': {
        computedValues: {
