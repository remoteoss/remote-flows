import { S as SupportedTypes } from '../types-ZWIpiFgj.js';
 ...
 */
declare function parseFormRadioValues(values: Record<string, unknown>, fieldKeys: string[]): ParsedRadioValues;
declare function findFieldsByType(fields: Record<string, any>, type: SupportedTypes): string[];

export { findFieldsByType, parseFormRadioValues };
