...
import { a8 as HelpCenterArticle } from './types.gen-CIMOKNAn.js';
...
declare const DAYS_OF_THE_WEEK: readonly ["monday", "tuesday", "wednesday", "thursday", "friday", "saturday", "sunday"];
type DailySchedule = {
    day: string;
    start_time: string;
    end_time: string;
...
declare function calculateHours(day: DailySchedule): number;
type Weekday = (typeof DAYS_OF_THE_WEEK)[number];
declare function getShortWeekday(fullName: Weekday): string;
...
export { type $TSFixMe as $, type ButtonComponentProps as B, type Components as C, type DrawerComponentProps as D, type FieldSetToggleComponentProps as F, type HelpCenterDataProps as H, type JSFFields as J, type Meta as M, type PDFPreviewComponentProps as P, type RemoteFlowsSDKProps as R, type StatementComponentProps as S, type TableComponentProps as T, type WorkScheduleComponentProps as W, type ZendeskDrawerComponentProps as Z, type JSFFieldset as a, type JSFCustomComponentProps as b, type JSFField as c, type FieldComponentProps as d, type FileComponentProps as e, type CountryComponentProps as f, type TextFieldComponentProps as g, type DatePickerComponentProps as h, type PricingPlanComponentProps as i, type PricingPlanDataProps as j, calculateHours as k, DAYS_OF_THE_WEEK as l, getShortWeekday as m, type DailySchedule as n };
